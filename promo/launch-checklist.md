...
- [ ] Post the workflow explanation on X.
- [ ] Reply manually to real questions.
- [ ] Log stars after 1h, 6h, and 24h.
- [ ] Fix README confusion quickly.
- [ ] Collect repeated questions into `promo/reply-bank.md`.
...
- [ ] Record issues and docs gaps.

## Follow-up

- [ ] Rewrite the README using the message people repeated back.
- [ ] Open issues for real product gaps.
- [ ] Decide whether the next work is packaging, model manager, or install stability.
